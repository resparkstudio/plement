...
$contact_information = get_field( 'information', $contact_us_id );
...
<div class=" w-full lg:w-[23.25rem] p-5 flex flex-col lg:justify-between bg-mainBlack text-white sticky top-[6rem]"
	...
	<div>
		<div class="mb-8">
			<h3 class="mb-2 text-h5Bold"><?php esc_html_e( $contact_information['heading'] ) ?></h3>
