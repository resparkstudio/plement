...
<section id="faq" class="py-24">
	<div class="container">
		<div
			class="grid grid-cols-1 justify-center items-start gap-x-16 gap-y-5 xl:gap-28 lg:grid-cols-2 lg:justify-between max-lg:max-w-2xl mx-auto max-w-full">
			<div class="w-full h-full flex flex-col justify-between">
				<h2 class="max-w-md"><?php echo esc_html( $faq_content['heading'] ) ?></h2>
				<?php if ( ! $is_contact_us ) : ?>
					<div class="hidden lg:block">
						<span
							class="text-textGray font-medium mb-2"><?php esc_html_e( 'Still got a question?', 'plmt' ) ?></span>
		...
		<?php if ( ! $is_contact_us ) : ?>
			<div class="lg:hidden flex flex-col items-center mt-14 gap-2">
				<span class="text-textGray font-medium"><?php esc_html_e( 'Still got a question?', 'plmt' ) ?></span>
				<div class="flex items-center gap-2">
