...
<section id="services" class="container bg-lightGrayBg py-[3.75rem] lg:px-10 lg:mt-20 lg:pt-[7.5rem] lg:pb-[4.375rem]">
	...
	<ul class="grid grid-cols-1 lg:justify-center lg:grid-cols-[repeat(2,420px)] gap-x-[7.5rem] gap-y-8 mb-10 lg:mb-16">
	...
	<div class="grid grid-cols-1 gap-2 lg:justify-center lg:grid-cols-[repeat(2,420px)] lg:gap-[7.5rem]">
		<p class="text-darkGray text-center lg:text-left">
