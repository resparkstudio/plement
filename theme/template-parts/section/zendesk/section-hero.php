...
<section id='hero' class='mb-6  lg:mb-20 flex flex-col bg-mainBlack text-white relative '>
	<div
		...
		<div class='lg:w-1/2 hero-content px-5 lg:px-0 z-10'>
			...
			<div class='flex flex-wrap'>
				...
				<?php if ( $hero_content['secondary_button'] ) : ?>
					<?php plmt_button( esc_url( $hero_content['secondary_button']['url'] ), esc_attr( $hero_content['secondary_button']['title'] ), array( 'classes' => '!w-[10rem] h-full justify-center lg:!w-[16.875rem] scroll-to lg:py-5 text-white border-darkGray2 !bg-darkGray2 hidden lg:inline-flex', 'variant' =>
						'secondary' ) ) ?>
				<?php endif; ?>
			</div>
		</div>
