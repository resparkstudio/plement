	...
	<div class="relative flex flex-col items-center justify-center text-center mb-8 md:mb-2">
		...
		<div class="flex justify-center max-w-[25rem] m-auto w-full mb-4 md:mb-5">
			<div class="relative flex w-full p-1 bg-white rounded-full">
				...
				<button class="relative flex-1 py-4 rounded-full font-semibold transition-colors duration-300 ease-in-out"
				...
				<button
					class="relative flex-1 font-semibold py-4 rounded-full transition-colors duration-300 ease-in-out w-max"
