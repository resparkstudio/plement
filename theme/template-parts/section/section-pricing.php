...
function package_cards($packages)
{
	...
	?>
	<div x-cloak>
		<div class="max-w-sm mx-auto grid grid-flow-col lg:max-w-none items-center py-[14px]">
			<?php foreach ($packages as $package): ?>
					...
					<div
						...
						<div class="h-full flex flex-col justify-between">
							<div>
								...
								<?php plmt_button("modalOpen=true;selectedPackage='" . esc_js($package['title']) . "'", esc_html__($package['button_text'], 'plmt'), array(
									"classes" => "pricing-button w-full text-bodyBold h-auto py-5 justify-center",
									"variant" => !$package['is_best_value'] ? 'secondary' : 'primary',
									"is_button" => true,
									"value" => $package['title']
									...
									<div class="flex flex-col gap-3 border-t border-t-[#E9E9E9] pt-3 mt-3">
										<?php foreach ($package['bottom_items'] as $item): ?>
											<div class="flex items-center gap-1">
												...
												<?php if ($item['tooltip']): ?>
													<div class="shrink-0">
														<?php bottom_tooltip($item['tooltip']) ?>
													</div>
												<?php endif; ?>
											</div>
										<?php endforeach; ?>
