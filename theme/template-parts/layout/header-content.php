...
<header id="masthead" class="container py-[20px] lg:py-9 flex items-center justify-between relative bg-white">
	...
	<div x-data="{menuOpen: false}" class="lg:hidden">
		...
		<nav x-show="menuOpen" @click.away="menuOpen=false" x-cloak id="site-navigation"
			class="absolute z-[100] top-[72px] lg:top-[108px] left-0 w-full flex flex-col pb-10 bg-lightGrayBg  px-4 py-10"
