(() => {
  ...
  var categoryFilter = document.querySelectorAll(".category-filter");
  var toolFilter = document.querySelectorAll(".tool-filter");
  var filterCaseStudies = (category, tool) => {
    ...
    fetch("/wp-admin/admin-ajax.php", {
      ...
      response.json().then((response2) => {
        ...
        caseStudies.innerHTML = response2.html;
        ...
        const loadMoreButton2 = document.querySelector(".load-more-button");
        if (response2.moreCount) {
          loadMoreButton2.style.display = "block";
          loadMoreButton2.innerHTML = `See more (${response2.moreCount})`;
        } else {
  ...
  var loadMoreCaseStudies = (page2, category, tool) => {
    fetch("/wp-admin/admin-ajax.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded"
      ...
      response.json().then((response2) => {
        const caseStudies = document.querySelector(".case-studies-container");
        caseStudies.insertAdjacentHTML("beforeend", response2.html);
        if (!response2.has_more_posts) {
  ...
  var industryFilter = document.querySelectorAll(".industry-filter");
  var platformFilter = document.querySelectorAll(".platform-filter");
  ...
  var blogsLoadMoreBtn = document.getElementById("blogs-load-more");
  var blogOffset = blogsLoadMoreBtn ? parseInt(blogsLoadMoreBtn.dataset.offset || "0", 10) : 0;
  var currentBlogIndustry = getParamValue("industry") || "";
  var currentBlogPlatform = getParamValue("platform") || "";
  var updateBlogLoadMore = (hasMore, nextOffset) => {
    if (!blogsLoadMoreBtn)
      return;
  ...
  var filterBlogs = (industry, platform) => {
    ...
    const fetchBlogs = async () => {
      ...
      try {
        ...
        if (data.success && data.data.html !== void 0) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const results = document.getElementById("blogs-results");
    if (!industrySelect || !platformSelect || !results)
      return;
    const fetchBlogs = async () => {
      results.style.opacity = "0.5";
      try {
  ...
  var handleContactFormTransition = function() {
  ...
  var smoothScrollToElementById = (hash) => {
  ...
  var handleButtonsWithScrollTriggerRefresh = () => {
  ...
  function initBlogContentsScroll() {
    ...
    if (!blogScrollToLinks || blogScrollToLinks.length === 0)
      return;
